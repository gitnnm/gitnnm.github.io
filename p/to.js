(function () {
    ...
    function videocdn(component) {
      ...
      function extractFile(str, max_quality) {
        ...
        try {
          ...
          url = items[0].replace(/1080/,'720').file;
          url = 'http:' + url.slice(0, url.lastIndexOf('/')) + '/' + (max_quality || items[0].replace(/1080/,'720').quality) + '.mp4';
	 // url = url.replace(/cloud.cdnland.in/, 'arkmv.ru:2086');
        } catch (e) {}
      ...
      function append(items) {
        ...
        items.forEach(function (element) {
          ...
          var item = Lampa.Template.get('stream_v2', element);
        ...
        network["native"](url, function (str) {
          ...
          if (videos) {
            ...
            if (link) {
              ...
              call(link[1].replace(/https/, 'http') + 'mp4');
            } else error();
          } else error();
        }, error, false, {
          dataType: 'text'
    ...
    function component(object) {
      ...
      this.find = function () {
        ...
        url = Lampa.Utils.addUrlComponent(url, 'api_token=Z8Ti5OsZycchHvCwL3nEI7FdwO7vI6mR');
    ...
    function startPlugin() {
      ...
      Lampa.Listener.follow('full', function (e) {
        if (e.type == 'complite') {
          var btn = Lampa.Template.get('button_stream');
    ...
    if (!window.plugin_stream_v2_ready) startPlugin();
