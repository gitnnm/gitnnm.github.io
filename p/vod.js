(function () {
    ...
    function videocdn(component) {
      ...
      function extractData(results) {
        ...
        if (movie) {
          var src = movie.iframe_src.replace(/[0-9]{1,4}.svetacdn.in/, 'arkmv.ru:1111');
    ...
    function component(object) {
      ...
      this.find = function () {
        ...
        var url = 'http://arkmv.ru:1111/api/';
