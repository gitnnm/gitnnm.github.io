...
$all = json_decode(file_get_contents("http://kodikapi.com/search?token=183357c2717eb92645a2fc0309fe675a&types=russian-movie,multi-part-film,russian-documentary-serial,documentary-serial,russian-serial&with_episodes=true&with_material_data=true&title=".$film))->results;
$array = [];
foreach ($all as $item) {
